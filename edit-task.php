...
if(isset($_POST['update_project_info'])){
    $obj_admin->update_project_info($_POST,$task_id, $user_role);
}
                        ...
                        <div class="col-md-12">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <input type="text" placeholder="Title" id="task_title" name="task_title" list="expense" class="form-control" value="<?php echo $row['t_title']; ?>" <?php if($user_role != 1){ ?> readonly <?php } ?> val required>
			                    </div>
			                  </div>
			                  <div class="form-group">
			                    <label class="control-label col-sm-5"> Description</label>
			                    <div class="col-sm-7">
			                      <textarea name="task_description" id="task_description" placeholder=" Discription" class="form-control" rows="5" cols="5"><?php echo $row['t_description']; ?></textarea>
			                    </div>
			                  </div>
			                  <div class="form-group">
			                  ...
			                  <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <?php 
			                        $sql = "SELECT user_id, fullname FROM users WHERE user_role = 2";
			                        $info = $obj_admin->manage_all_info($sql);   
			                      ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <button type="submit" name="update_project_info" class="btn btn-success-custom">Update Now</button>
                              </div>
                            </div>
                          </form> 
                        </div>
